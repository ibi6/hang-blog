 ...
 *
 * `SocialIcon` — shared inline SVG icons for platforms referenced in the
 * Footer and Contact page. Extracted so multiple components can render a
 * consistent icon without duplicating SVG paths.
 */
...
export function SocialIcon({ platform }: { platform: string }): JSX.Element {
  switch (platform) {
    case "github":
      return <GitHubIcon />;
    case "linkedin":
